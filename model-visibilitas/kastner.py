...
def crescent_area(elongation_deg: float, r_deg: float) -> float:
    ...
    Rumus: A = 1/2 * pi * r² * (1 - cos(elongation))
    ...
    return 0.5 * math.pi * (r_deg ** 2) * (1 - math.cos(elong_rad))
...
if __name__ == "__main__":
    ...
    # Contoh 2: Menghitung luas sabit untuk Crumey visibility margin
    ...
    # Contoh integrasi dengan crumey_telescope_correction:
    # from crumey_telescope_correction import TelescopeSpec, visibility_margin
    #
